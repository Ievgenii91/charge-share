...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    isProvider: Attribute.Boolean;
    avatar: Attribute.Media;
    invoiceId: Attribute.UID;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'plugin::users-permissions.user',
...
export interface ApiConsumerConsumer extends Schema.CollectionType {
  ...
  attributes: {
    ...
    user: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    isCharging: Attribute.Boolean;
    provider: Attribute.Relation<
      'api::consumer.consumer',
      'oneToOne',
      'api::provider.provider'
    >;
    chargeStartDate: Attribute.DateTime;
    chargeEndDate: Attribute.DateTime;
    chargeHours: Attribute.Decimal;
...
export interface ApiFeaturesConfigFeaturesConfig extends Schema.SingleType {
  ...
  attributes: {
    arePaymentsEnabled: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<true>;
    monthlySubscriptionCost: Attribute.Integer &
      Attribute.Required &
      Attribute.DefaultTo<99>;
    annualSubscriptionCost: Attribute.Integer &
      Attribute.Required &
      Attribute.DefaultTo<999>;
    paymentsProvider: Attribute.Enumeration<['monobank', 'liqpay', 'fondy']> &
      Attribute.Required &
      Attribute.DefaultTo<'monobank'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSubscriptionSubscription extends Schema.CollectionType {
  ...
  attributes: {
    ...
    user: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    provider: Attribute.Enumeration<['monobank', 'liqpay', 'fondy']>;
    status: Attribute.Enumeration<['created', 'processing', 'success']>;
    type: Attribute.Enumeration<['monthly', 'annual', 'full', 'promo']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::subscription.subscription',
